...
<div class="spinner-wrapper">
  ...
  <div id="evenements" class="container-fluid my-5">
    <div class="row w-100 mb-5 mb-xl-0">
      ...
      <div class="col-xl-6 col-mb-10 order-2 p-0 m-auto">
        <img class="evenementimg evenementimg-2 img-fluid d-block" src="img/capture_rde/express_3.jpg">
      </div>
    </div>
    ...
    <div class="row w-100 mb-5  mt-5 mt-xl-0">
      <div class="col-xl-6 col-mb-10 order-xl-3 order-4 p-0 m-auto">
        <img class="evenementimg evenementimg-1 img-fluid d-block" src="img/capture_rde/warrior_10.jpg">
      </div>
  ...
  <div class="container-fluid testi-back" style="background-image: url(img/gacolor.jpg);">
  ...
  <div class="container-fluid mt-2 mb-5 pr-5 pl-5 persp">
    ...
    <div class="row">
      <div class="col-12 col-sm-6 col-lg-3 p-2 my-auto"><div class="polaroid mx-auto">
        <a class="" href="event.php#galerie"><img class="img-fluid" src="img/capture_rde/warrior_11.jpg"></a>
        <p class="policep text-center">Carolo Warrior</p>
      </div></div>
      <div class="col-12 col-sm-6 col-lg-3 p-2 my-auto"><div class="polaroid mx-auto">
        <a class="" href="event.php#galerie"><img class="img-fluid" src="img/capture_rde/express_3.jpg"></a>
        <p class="policep text-center">Carolo Express</p>
      </div></div>
      <div class="col-12 col-sm-6 col-lg-3 p-2 my-auto"><div class="polaroid mx-auto">
        <a class="" href="event.php#galerie"><img class="img-fluid" src="img/capture_rde/cuisine.jpg"></a>
