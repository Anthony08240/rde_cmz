  ...
  <div class="container mask-1">
    ...
    <div class="row w-100 text-center">
      <div class="col-xl-6 col-mb-10 order-xl-3 order-4 p-0 m-auto">
        <img class="evenementimg evenementimg-1 img-fluid d-block" src="img/event_2019/5.jpg">
      </div>
    ...
    <div class="container-fluid my-5">
        <div class="row w-100 mb-5 mb-xl-0">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6"><img src="img/mascotte_montre.png" style="width:100%;"></div>
                <a class="btn-sinscrire" class="btn-sinscrire" href="event_register_piquenique.php"><button class="btn btn-secondary"><h2 class="policetitres" style="color: var(--color-yellow-middle); margin-bottom: 0!important;">S'inscrire</h2></button></a>
            </div>
            </div>
        </div>
    </div>
