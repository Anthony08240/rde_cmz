...
<body>
  ...
  <section class="get-in-touch container-lg">
    ...
    <form id="inscription" class="contact-form row w-100 justify-content-center" action="traitements/expressregister.php" method="post">
      <div class="form-field col-11 col-sm-11 col-md-10 col-lg-8 col-xl-7">
        <center><select class="custom-select" name="etablissement" id="etablissement-font-3" required>
